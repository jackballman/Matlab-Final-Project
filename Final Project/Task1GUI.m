...
% Last Modified by GUIDE v2.5 03-Dec-2016 19:07:18
...
set(handles.edit2,'string',vx(i));
set(handles.edit3,'string',vy(i));
xsum = sum(vx);
ysum = sum(vy);
Rmag = sqrt(xsum + ysum);
Rang = atand(ysum/xsum);
set(handles.edit4,'string',Rmag)
set(handles.edit5,'string',Rang)
axes(handles.axes1)
...
% --- Executes on button press in clearcalc.
function clearcalc_Callback(hObject, eventdata, handles)
% hObject    handle to clearcalc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
